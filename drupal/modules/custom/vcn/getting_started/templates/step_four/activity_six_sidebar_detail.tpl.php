...
<p style="margin-left:10px; margin-right:10px; text-align:justify">Submit an application online today.</p>
 		...
 		if ((string)$training->provider->adminurl !== 'NULL' AND trim((string)$training->provider->adminurl) != '')
	   	{
	    	...
	    	echo '<a target="_blank" href="'.$adminurl.'">'.$training->provider->instnm .' Admissions</a>';
	    }	
   	?> 
