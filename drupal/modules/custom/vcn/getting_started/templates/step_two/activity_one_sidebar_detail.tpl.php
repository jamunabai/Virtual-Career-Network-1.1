...
<div id="step-1-actvity-1-sidebar-content">
    <div style="margin-right:10px" class="vcn-gs-heading">How to Choose a <br />Career<br/><br/></div>
    <div id="video-link">
        <a href="/careerladder/gsvideos/AACC_VCN2.flv" toptions="width = 425, height = 240, resizable = 1, layout=flatlook, shaded=1" title="Watch Video" alt="Watch Video">
         <img height="154" width="188" src="<?php echo base_path(); ?>sites/all/modules/custom/vcn/getting_started/images/step2.png" alt="Watch Video" class="imgA1">
