...
<!-- div class="vcn-gs-heading">My Professional Training</div -->

<?php
if(!isset($_GET['ace_id'])) {
?>
<h4>College Credit for Professional Training</h4>
<p> 
Have you completed professional training provided by your employer or other work-related 
organizations, such as a professional association? Your training may be equivalent to 
college-level learning and may have ACE credit recommendations.
</p>
<?php
}
