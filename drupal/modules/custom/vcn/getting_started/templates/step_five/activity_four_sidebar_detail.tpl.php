...
$query="SELECT COURSE_CODE from vcn_cma_user_course WHERE USER_ID=\"$USER_ID\" AND MILITARY_YN=\"C\"";
    $connection=connectIt();
    ...
    while($row=mysql_fetch_assoc($result))
      ...
      //$connection2=connectIt2();
      $select2="SELECT * FROM vcn_ace_national_course_credit WHERE ace_id=\"$tmpAceID\" AND start_date=\"$tmpStartDate\" AND end_date=\"$tmpEndDate\"";
      $result2=mysql_query($select2) or die("error extracting national course credits: ".mysql_error());
