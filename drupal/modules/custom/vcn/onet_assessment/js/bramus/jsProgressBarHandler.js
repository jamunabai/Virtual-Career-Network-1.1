...
// the variable appPath is set within the onet_assessment.module PHP script
  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: appPath + '/images/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: appPath + '/images/bramus/percentImage_back4.png',	// Image to use in the progressbar. Can be an array of images too.
