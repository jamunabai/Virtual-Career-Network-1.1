...
window.open('<?php echo base_path(); ?>educationmatch/current/'+document.getElementById('training1').value+'/towards/'+document.getElementById('training2').value,'_self');
...
<li><a href="<?php echo base_path(); ?>careerdetails?onetcode=<?php echo $trainingone->occupation[$i]->onetcode; ?>"><?php echo $trainingone->occupation[$i]->displaytitle; ?></a></li>
...
<div id="work-towards">
	...
	for ($i=0; $i<=82; $i++): 
		if ($trainingtwo->occupation[$i]->displaytitle && !in_array((string)$trainingtwo->occupation[$i]->onetcode,$titlear)): 
			$foundone = true;
	?>
	<li><a href="<?php echo base_path(); ?>careerdetails?onetcode=<?php echo $trainingtwo->occupation[$i]->onetcode; ?>"><?php echo $trainingtwo->occupation[$i]->displaytitle; ?></a></li>
	<?php 
		endif; 
	endfor; 
	...
	<!--
	<div style="margin-left:20px;">
	<a href="javascript:void(0);" onclick="window.open('<?php echo base_path(); ?>careergrid/education_category_id_less_2/'+document.getElementById('training2').value,'_self');">(see all)</a>
	</div>
	-->
...
<strong><a href="<?php echo base_path(); ?>careergrid">Explore All Careers ></a></strong>
