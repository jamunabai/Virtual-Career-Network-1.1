...
(function($) {
	$.extend({
		tablesorterPager: new function() {
			...
			function moveTofirst1Page(table) {
				var c = table.config;
				c.page = 0;
				moveToPage(table);
			}
			
			function moveTolast1Page(table) {
				var c = table.config;
			...
			this.construct = function(settings) {
				...
				return this.each(function() {	
					...
					$('.five').live('click', function() {
						moveToFivePage(table);
						return false;
					});
										
					$('.six').live('click', function() {
						moveToSixPage(table);
						return false;
					});
										
					$('.seven').live('click', function() {
						moveToSevenPage(table);
						return false;
					});
										
					$('.eight').live('click', function() {
						moveToEightPage(table);
						return false;
					});
										
					$('.nine').live('click', function() {
						moveToNinePage(table);
						return false;
					});
										
					$('.ten').live('click', function() {
						moveToTenPage(table);
						return false;
					});
					
					$('.eleven').live('click', function() {
						moveToElevenPage(table);
						return false;
					});
					
					$('.twelve').live('click', function() {
						moveToTwelvePage(table);
						return false;
					});			

					$('.thirteen').live('click', function() {
						moveToThirteenPage(table);
						return false;
					});

					$('.fourteen').live('click', function() {
						moveToFourteenPage(table);
						return false;
					});		

					$('.fifteen').live('click', function() {
						moveToFifteenPage(table);
						return false;
					});					
					
					
					$('.sixteen').live('click', function() {
						moveToSixteenPage(table);
						return false;
					});
										
					$('.seventeen').live('click', function() {
						moveToSeventeenPage(table);
						return false;
					});
										
					$('.eightteen').live('click', function() {
						moveToEightteenPage(table);
						return false;
					});
										
					$('.nineteen').live('click', function() {
						moveToNineteenPage(table);
						return false;
					});
										
					$('.twenty').live('click', function() {
						moveToTwentyPage(table);
						return false;
					});
										
					$('.twentyone').live('click', function() {
						moveToTwentyonePage(table);
						return false;
					});
										
					$('.twentytwo').live('click', function() {
						moveToTwentytwoPage(table);
						return false;
					});
										
					$('.twentythree').live('click', function() {
						moveToTwentythreePage(table);
						return false;
					});
										
					$('.twentyfour').live('click', function() {
						moveToTwentyfourPage(table);
						return false;
					});
					
					$('.twentyfive').live('click', function() {
						moveToTwentyfivePage(table);
						return false;
					});
					
					$('.twentysix').live('click', function() {
						moveToTwentysixPage(table);
						return false;
					});			

					$('.twentyseven').live('click', function() {
						moveToTwentysevenPage(table);
						return false;
					});

					$('.twentyeight').live('click', function() {
						moveToTwentyeightPage(table);
						return false;
					});		

					$('.twentynine').live('click', function() {
						moveToTwentyninePage(table);
						return false;
					});		

					$('.thirty').live('click', function() {
						moveToThirtyPage(table);
						return false;
					});
										
					$('.thirtyone').live('click', function() {
						moveToThirtyonePage(table);
						return false;
					});
										
					$('.thirtytwo').live('click', function() {
						moveToThirtytwoPage(table);
						return false;
					});
					
					$('.thirtythree').live('click', function() {
						moveToThirtythreePage(table);
						return false;
					});
					
					$('.thirtyfour').live('click', function() {
						moveToThirtyfourPage(table);
						return false;
					});			

					$('.thirtyfive').live('click', function() {
						moveToThirtyfivePage(table);
						return false;
					});

					$('.thirtysix').live('click', function() {
						moveToThirtysixPage(table);
						return false;
					});		

					$('.thirtyseven').live('click', function() {
						moveToThirtysevenPage(table);
						return false;
					});					
					
					
					$('.thirtyeight').live('click', function() {
						moveToThirtyeightPage(table);
						return false;
					});
										
					$('.thirtynine').live('click', function() {
						moveToThirtyninePage(table);
						return false;
					});
										
					$('.fourty').live('click', function() {
						moveToFourtyPage(table);
						return false;
					});
										
					$('.fourtyone').live('click', function() {
						moveToFourtyonePage(table);
						return false;
					});
										
					$('.fourtytwo').live('click', function() {
						moveToFourtytwoPage(table);
						return false;
					});
										
					$('.fourtythree').live('click', function() {
						moveToFourtythreePage(table);
						return false;
					});
										
					$('.fourtyfour').live('click', function() {
						moveToFourtyfourPage(table);
						return false;
					});
										
					$('.fourtyfive').live('click', function() {
						moveToFourtyfivePage(table);
						return false;
					});
										
					$('.fourtysix').live('click', function() {
						moveToFourtysixPage(table);
						return false;
					});
					
					$('.fourtyseven').live('click', function() {
						moveToFourtysevenPage(table);
						return false;
					});
					
					$('.fourtyeight').live('click', function() {
						moveToFourtyeightPage(table);
						return false;
					});			

					$('.fourtynine').live('click', function() {
						moveToFourtyninePage(table);
						return false;
					});

					$('.fifty').live('click', function() {
