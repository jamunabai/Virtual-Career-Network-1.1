...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language->language; ?>" lang="<?php print $language->language; ?>" dir="<?php print $language->dir; ?>" xmlns:fb="https://www.facebook.com/2008/fbml">
...
<?php
//if (strstr($_SERVER['REQUEST_URI'],'step-one'))
	//echo 'style="top:460px;"';
//if (strstr($_SERVER['REQUEST_URI'],'step-two')) {
	//echo 'style="top:50%;"';	
	//}

?>
>
<center><img alt="Loading" src="<?php echo base_path(); ?>/sites/all/themes/zen_hvcp/images/loading.gif" />&nbsp;&nbsp;&nbsp;Loading</center></div>

  <?php if ($primary_links || $navigation): ?>
    <div id="skip-link"><a href="<?php echo ($primary_links) ? '#main-menu' : '#navigation'; ?>"><?php print t('Jump to Navigation'); ?></a></div>
  <?php endif; ?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="main-wrapper"><div id="main" class="clearfix<?php if ($primary_links || $navigation) { print ' with-navigation'; } ?>">
      ...
      <div id="content" class="column"><div class="section">
		...
		<?php // add prefix to title for test pages		
        ...
        <?php endif; 
          //remove the code that only printed messages for admins so users could see
          //the form validation errors regardless of their role/permissions
          //wrote the developer messages to a log and turned off database logging
        print $messages; ?>
	    <?php if ($tabs): ?>
	       <?php // don't show tabs on quiz page
		   if (($node->type!="quiz") && ($node->type!="multichoice")) {
		      ?>
              <div class="tabs"><?php print $tabs; ?></div>
		      <?php
           } else { // for quiz page, show student info			   
			   $student_name = $_SESSION['student_name'][0];
	           if (empty($student_name)) {
		           $content = "Invalid student";
	           } else {
	               $content = "<br /><div id=\"studentinfo\"><b>Student: " . $student_name . "</b></div><br />" . $content;
			   }
		   }
		?>
        <?php endif; ?>
