...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_Language', 'doctrine');

/**
 * VCN_Model_Base_Language
 * 
 ...
 */
abstract class VCN_Model_Base_Language extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_language');
