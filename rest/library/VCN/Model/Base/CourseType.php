...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CourseType', 'doctrine');

/**
 * VCN_Model_Base_CourseType
 * 
 ...
 */
abstract class VCN_Model_Base_CourseType extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_course_type');
