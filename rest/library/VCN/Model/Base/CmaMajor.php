...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CmaMajor', 'doctrine');

/**
 * VCN_Model_Base_CmaMajor
 * 
 ...
 */
abstract class VCN_Model_Base_CmaMajor extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_cma_major');
