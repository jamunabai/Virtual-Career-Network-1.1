...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_ProviderCourseReq', 'doctrine');

/**
 * VCN_Model_Base_VcnProviderCourseReq
 * 
 ...
 * @property VCN_Model_VcnCourse $VcnCourse
 ...
 */
abstract class VCN_Model_Base_ProviderCourseReq extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_provider_course_req');
