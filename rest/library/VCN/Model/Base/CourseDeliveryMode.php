...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CourseDeliveryMode', 'doctrine');

/**
 * VCN_Model_Base_CourseDeliveryMode
 * 
 ...
 */
abstract class VCN_Model_Base_CourseDeliveryMode extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_course_delivery_mode');
