...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_ProviderContact', 'doctrine');

/**
 * VCN_Model_Base_ProviderContact
 * 
 ...
 * @property string $PROVIDER_CONTACT_YN
 ...
 */
abstract class VCN_Model_Base_ProviderContact extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_provider_contact');
        ...
        $this->hasColumn('PHONE_EXT', 'string', 5, array(
             'type' => 'string',
             'length' => 5,
             'fixed' => false,
             'unsigned' => false,
        ...
        $this->hasColumn('PROVIDER_CONTACT_YN', 'string', 1, array(
             'type' => 'string',
             'length' => 1,
             'fixed' => true,
             'unsigned' => false,
    ...
    public function setUp()
    {
        ...
        $this->hasMany('VCN_Model_CourseContact as VcnCourseContact', array(
             'local' => 'CONTACT_ID',
             'foreign' => 'CONTACT_ID'));
    }
}