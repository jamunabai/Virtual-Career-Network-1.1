...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CourseCipcode', 'doctrine');

/**
 * VCN_Model_Base_CourseCipcode
 * 
 ...
 */
abstract class VCN_Model_Base_CourseCipcode extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_course_cipcode');
