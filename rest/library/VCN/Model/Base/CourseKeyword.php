...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CourseKeyword', 'doctrine');

/**
 * VCN_Model_Base_CourseKeyword
 * 
 ...
 */
abstract class VCN_Model_Base_CourseKeyword extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_course_keyword');
    ...
    {
        parent::setUp();
  		$this->hasOne('VCN_Model_Keyword as Keyword', array(
             'local' => 'KEYWORD_ID',
             'foreign' => 'KEYWORD_ID'));
    }
}