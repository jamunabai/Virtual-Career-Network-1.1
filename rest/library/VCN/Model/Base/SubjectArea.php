...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_SubjectArea', 'doctrine');

/**
 * VCN_Model_Base_VcnSubjectArea
 * 
 ...
 */
abstract class VCN_Model_Base_SubjectArea extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_subject_area');
