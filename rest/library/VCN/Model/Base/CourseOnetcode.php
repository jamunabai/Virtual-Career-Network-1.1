...
Doctrine_Manager::getInstance()->bindComponent('VCN_Model_CourseOnetcode', 'doctrine');

/**
 * VCN_Model_Base_CourseOnetcode
 * 
 ...
 */
abstract class VCN_Model_Base_CourseOnetcode extends VCN_DoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('vcn_course_onetcode');
