 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_CmaUserTest extends VCN_Model_Base_CmaUserTest
{
	protected $valid = array('USER_TEST_ID','USER_ID','TEST_CODE','TEST_DATE','TEST_RESULT');
    ...
    * @return array $select
    */	
	public function countCmaUserTest($params, $fields=false) 
	{
	...
	public function listCmaUserTest($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getCmaUserTest($params, $fields=false) 
	{
