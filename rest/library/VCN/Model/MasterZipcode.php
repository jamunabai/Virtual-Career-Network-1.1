 ...
 * MasterZipcode
 */
class VCN_Model_MasterZipcode extends VCN_Model_Base_MasterZipcode
{
	protected $valid = array('ZIP','STATE','COUNTY');
	
	public function countMasterZipcode($params, $fields=false) 
	{
		...
		$stmt->from ('VCN_Model_MasterZipCode mz') 
 			 ->leftJoin('mz.Licstate ls');
	...
	public function listMasterZipcode($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getMasterZipcode($params, $fields=false) 
	{
  		$query = $this->parseParams($params, $this->valid);
