 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_Ability extends VCN_Model_Base_Ability
{
    ...
    * @return array $select
    */	
	public function countAbility($params, $fields=false) 
	{
	...
	public function listAbility($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getAbility($params, $fields=false) 
	{
