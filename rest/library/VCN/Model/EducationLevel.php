 ...
 */
class VCN_Model_EducationLevel extends VCN_Model_Base_EducationLevel
{
    ...
    * @return array $select
    */	
	public function countEducationLevel($params, $fields=false) 
	{
	...
	public function listEducationLevel($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
...
public function getEducationLevel($params, $fields=false) 
	{
