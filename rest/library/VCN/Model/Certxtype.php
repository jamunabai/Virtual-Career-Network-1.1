 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_Certxtype extends VCN_Model_Base_Certxtype
{
	protected $valid = array('CERT_ID','CERT_TYPE');
    ...
    * @return array $select
    */	
	public function countCertxtype($params, $fields=false) 
	{
	...
	public function listCertxtype($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getCertxtype($params, $fields=false) 
	{
 
 		$query = $this->parseParams($params, $this->valid);
 	 	$required = array('cert_id','cert_type');
