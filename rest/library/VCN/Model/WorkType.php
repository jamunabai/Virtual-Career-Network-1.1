 ...
 * 
 */
class  VCN_Model_WorkType extends VCN_Model_Base_WorkType {
	...
	public function countWorkType($params) 
	{
	...
	public function listWorkType($params) {
    	$query = $this->parseParams($params);
	...
	public function getWorkType($params) {
		...
		if (!isset($params['code'])) 
	 	{
	 		$this->setResult('fail','Missing Parameters: code', $params, false);
	 		return $this->result;
	 	}
	 	elseif (is_array($params['code']))
	 	{
	 		$this->setResult('fail','Multiple values for Parameters: code',$params, false);
	 		return $this->result;
	 	}
 		$stmt = $this->getTable()->createquery();
        if ($query['where']) {
