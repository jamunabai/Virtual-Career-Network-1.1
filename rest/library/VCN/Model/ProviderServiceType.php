 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_ProviderServiceType extends VCN_Model_Base_ProviderServiceType
{
    ...
    * @return array $select
    */	
	public function countProviderServiceType($params, $fields=false) 
	{
	...
	public function listProviderServiceType($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getProviderServiceType($params, $fields=false) 
	{
