 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_ProviderDetail extends VCN_Model_Base_ProviderDetail
{
    ...
    * @return array $select
    */	
	public function countProviderDetail($params, $fields=false) 
	{
	...
	public function listProviderDetail($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getProviderDetail($params, $fields=false) 
	{
