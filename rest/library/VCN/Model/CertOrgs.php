 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_CertOrgs extends VCN_Model_Base_CertOrgs
{
	protected $valid = array('ORG_ID','ORG_NAME','ORG_WEBPAG');
    ...
    * @return array $select
    */	
	public function countCertOrgs($params, $fields=false) 
	{
	...
	public function listCertOrgs($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getCertOrgs($params, $fields=false) 
	{
