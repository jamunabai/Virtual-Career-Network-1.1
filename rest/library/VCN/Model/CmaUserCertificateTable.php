...
/**
 * VCN_Model_CmaUserCertificateTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class VCN_Model_CmaUserCertificateTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object VCN_Model_CmaUserCertificateTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('VCN_Model_CmaUserCertificate');
    }

    public function listUserCertificates($user_id)
    {
        $sql = self::getInstance()->createQuery();
        $sql->where('USER_ID = ?',$user_id);

        $sql->orderBy('DATE_CERTIFICATE_OBTAINED DESC');
    ...
    public static function updateUserCertificate($form_values)
    {
        $table = self::getInstance();
        $columns = $table->getColumnNames();
  //      error_log('updateUserCertificate form_values: ' . print_r($form_values,TRUE));
  //      error_log('List of columns in Certificate Table: ' . print_r($columns,TRUE));
        if (isset($form_values['REC_ID'])) {
            ...
            $record = new VCN_Model_CmaUserCertificate();
...
//        error_log('About to save Certificate Record: ' . print_r($record->toArray(),TRUE));
        $record->save();

        return self::_returnStatus('success','Record Updated',$form_values,NULL);
    }

    public static function getUserCertificate($record_id)
    {
        $table = self::getInstance();
