 ...
 */
class VCN_Model_OccupationLegalRequirement extends VCN_Model_Base_OccupationLegalRequirement
{

public function countOccupationLegalRequirement($params, $fields=false) 
	{
	...
	public function listOccupationLegalRequirement($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
