...
/**
 * VCN_Model_CmaUserCourseTable
 *
 * This class has been manually generated by jkurrle
 */
class VCN_Model_CmaUserCourseTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object VCN_Model_CmaUserCourseTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('VCN_Model_CmaUserCourse');
    }

    public static function listUserCourse($user_id)
    {
        $sql = self::getInstance()->createQuery();
        $sql->where('USER_ID = ?',$user_id);

        //$sql->orderBy('YEAR_GRADUATED DESC');
    ...
    public static function updateUserCourse($form_values)
    {
        $table = self::getInstance();
        $columns = $table->getColumnNames();
  //      error_log('updateUserCourse form_values: ' . print_r($form_values,TRUE));
  //      error_log('List of columns in Course Table: ' . print_r($columns,TRUE));
        if (isset($form_values['REC_ID'])) {
            ...
            $record = new VCN_Model_CmaUserCourse();
...
//        error_log('About to save Course Record: ' . print_r($record->toArray(),TRUE));
        $record->save();

        return self::_returnStatus('success','Record Updated',$form_values,NULL);
    }

    public static function getUserCourse($record_id)
    {
        $table = self::getInstance();
