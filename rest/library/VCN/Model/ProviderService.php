 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_ProviderService extends VCN_Model_Base_ProviderService
{
    ...
    * @return array $select
    */	
	public function countProviderService($params, $fields=false) 
	{
	...
	public function listProviderService($params, $fields=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getProviderService($params, $fields=false) 
	{
