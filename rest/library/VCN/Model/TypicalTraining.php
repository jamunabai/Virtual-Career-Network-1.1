 ...
 * 
 */
class  VCN_Model_TypicalTraining extends VCN_Model_Base_TypicalTraining {

	public function countTraining($params) 
	{
	...
	public function sortTraining($onetcode) {
	...
	public function listTraining($params) {
	 	$query = $this->parseParams($params);
