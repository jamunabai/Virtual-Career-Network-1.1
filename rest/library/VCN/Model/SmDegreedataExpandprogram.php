...
/**
 * SmDegreedataExpandprogram Class
 * 
 * 
 * @package    VCN
 * @subpackage
 ...
 * @version    SVN: $Id:$
 */
class VCN_Model_SmDegreedataExpandprogram extends VCN_Model_Base_SmDegreedataExpandprogram
{
	protected $valid = array('PROCESSED_STATUS');
    ...
    * @return array $select
    */	
	public function countSmDegreedataExpandprogram($params, $fields=false) 
	{
  ...
  // echo $stmt->getSqlQuery();exit;
	...
	public function listSmDegreedataExpandprogram($params, $fields=false, $raw=false) 
	{
    	$query = $this->parseParams($params, $this->valid);
	...
	public function getSmDegreedataExpandprogram($params, $fields=false) 
	{
