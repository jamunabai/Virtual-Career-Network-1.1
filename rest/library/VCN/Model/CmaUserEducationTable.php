...
/**
 * VCN_Model_CmaUserEducationTable
 * 
 * This class has been auto-generated by the Doctrine ORM Framework
 */
class VCN_Model_CmaUserEducationTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object VCN_Model_CmaUserEducationTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('VCN_Model_CmaUserEducation');
    }

    public static function listUserEducation($user_id)
    {
    ...
    public static function updateUserEducation($form_values)
    {
        $table = self::getInstance();
        $columns = $table->getColumnNames();
  //      error_log('updateUserEducation form_values: ' . print_r($form_values,TRUE));
  //      error_log('List of columns in Education Table: ' . print_r($columns,TRUE));
        if (isset($form_values['REC_ID'])) {
            ...
            $record = new VCN_Model_CmaUserEducation();
...
//        error_log('About to save Education Record: ' . print_r($record->toArray(),TRUE));
        $record->save();

        return self::_returnStatus('success','Record Updated',$form_values,NULL);
    }

    public static function getUserEducation($record_id)
    {
        $table = self::getInstance();
