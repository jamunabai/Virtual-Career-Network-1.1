 ...
 *
 */
class CmaSvc_CmaUserDocumentController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserDocument();
		$result = $model->countCmaUserDocument($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserDocument();
		$result = $model->listCmaUserDocument($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserDocument();
		$result = $model->saveCmaUserDocument($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserDocument();
		$result = $model->deleteCmaUserDocument($this->params);
