...
/**
 * @author jkurrle
 * using code from lingamp
 *
 */

class CmaSvc_CmaUserCourseeController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserCourse();
		$result = $model->countCmaUserCourse($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserCourse();
		$result = $model->listCmaUserCourse($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserCourse();
		$result = $model->saveCmaUserCourse($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserCourse();
		$result = $model->deleteCmaUserCourse($this->params);
