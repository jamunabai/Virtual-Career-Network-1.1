 ...
 *
 */
class CmaSvc_CmaUserShareController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserShare();
		$result = $model->countCmaUserShare($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserShare();
		$result = $model->listCmaUserShare($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserShare();
		$result = $model->saveCmaUserShare($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserShare();
		$result = $model->deleteCmaUserShare($this->params);
