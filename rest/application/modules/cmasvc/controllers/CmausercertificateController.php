 ...
 *
 */
class CmaSvc_CmaUserCertificateController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserCertificate();
		$result = $model->countCmaUserCertificate($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserCertificate();
		$result = $model->listCmaUserCertificate($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserCertificate();
		$result = $model->saveCmaUserCertificate($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserCertificate();
		$result = $model->deleteCmaUserCertificate($this->params);
