 ...
 *
 */
class CmaSvc_CmaUserJobScoutController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserJobScout();
		$result = $model->countCmaUserJobScout($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserJobScout();
		$result = $model->listCmaUserJobScout($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserJobScout();
		$result = $model->saveCmaUserJobScout($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserJobScout();
		$result = $model->deleteCmaUserJobScout($this->params);
