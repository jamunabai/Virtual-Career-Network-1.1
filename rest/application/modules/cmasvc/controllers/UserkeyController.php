 ...
 *
 */
class CmaSvc_UserKeyController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserKey();
		$result = $model->countCmaUserKey($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserKey();
		$result = $model->listCmaUserKey($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserKey();
		$result = $model->saveCmaUserKey($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserKey();
		$result = $model->deleteCmaUserKey($this->params);
