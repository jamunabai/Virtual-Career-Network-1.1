 ...
 *
 */
class CmaSvc_CmaUserEmploymentController extends VCN_WebServices {
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_CmaUserEmployment();
		$result = $model->countCmaUserEmployment($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_CmaUserEmployment();
		$result = $model->listCmaUserEmployment($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_CmaUserEmployment();
		$result = $model->saveCmaUserEmployment($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_CmaUserEmployment();
		$result = $model->deleteCmaUserEmployment($this->params);
