 ...
 *
 */
class CmaSvc_ZipxareaController extends VCN_WebServices {
    ...
    public function indexAction() {
 	...
 	public function listAction() {
     	$model = new VCN_Model_Zipxarea();
		$result = $model->listZipxarea($this->params);
...
/*	 public function getAction() {
     	$model = new VCN_Model_Zipxarea();
		$result = $model->getZipxarea($this->params);
