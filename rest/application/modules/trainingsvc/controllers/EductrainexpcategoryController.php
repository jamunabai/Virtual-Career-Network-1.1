 ...
 * 
 */
class TrainingSvc_EductrainexpCategoryController extends VCN_WebServices {
  ...
  /**
    ...
    */
	...
	public function countAction() {
		...
		$result = $model->countEductrainexpCategories( $this->params );
 		if (!$result) return $this->_forward('index');
	...
	*/
	public function listAction( ) {
 		$model  = new VCN_Model_EductrainexpCategories();
		$result = $model->listEductrainexpCategories($this->params);
