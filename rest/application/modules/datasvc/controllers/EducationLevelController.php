 ...
 *
 */
class DataSvc_EducationLevelController extends VCN_WebServices {

    /**
     *
     * @see Zend_Rest_Controller::getAction()
     */
/*    public function getEducationLevelListAction() {
        $data = VCN_Model_EducationLevelTable::getEducationLevelList();

        if ($this->format == 'json') {
            $data = json_encode($data);
        } else {
            $data = VCN_WebServices::toXml($data, 'result', 'educationLevels');
        }
...
/////////////////////////////////////////////////////prashanth////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public function indexAction() {
	 ...
	 public function countAction() {
		$model = new VCN_Model_EducationLevel();
		$result = $model->countEducationLevel($this->params);
 	...
 	public function listAction() {
     	$model = new VCN_Model_EducationLevel();
		$result = $model->listEducationLevel($this->params);
    ...
    public function putAction() {
    	$model = new VCN_Model_EducationLevel();
		$result = $model->saveEducationLevel($this->params);
    ...
    public function deleteAction() {
      	$model = new VCN_Model_EducationLevel();
		$result = $model->deleteEducationLevel($this->params);
