...
//echo "emaill=".$email."<br/>comment=".$comment;

mysql_query("INSERT INTO hvcp.vcn_comment (page_url, sender_email, subject, sender_comment, created_by, created_time) VALUES ('$url', '$email', '$subject', '$comment', '$by', '$datetime')");
