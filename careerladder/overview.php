...
if($client->property('browser') == "ie" || ($client->property('version')<=3.6 && $client->property('browser')=='mz')) {?>
  <div id="pagediv" style="background : #ffffff; width : 791px; height : 580px; overflow : auto; font-family : Verdana; font-size: 12px;">
<?php } else { ?>
  <div id="pagediv" style="background : #ffffff; width : 791px; height : 580px; overflow : auto; font-family : Verdana; font-size: 12px;">
<?php } ?>
...
<?php
	...
	echo $content->occupation->detaileddescription;
